...
$(document).ready(function(){
    ...
    $(document)
        ...
        .on('click.mrCloneBlock','[data-mr-event="cloneBlock"]',function(e){
            ...
            var class_remove_btn = $tmp_block.find('[data-mr-event="cloneBlock"]').length && $tmp_block.find('[data-mr-event="cloneBlock"]').data('mr-class-remove-btn')
                ?  $tmp_block.find('[data-mr-event="cloneBlock"]').data('mr-class-remove-btn')
                : '';
            $tmp_block.find('[data-mr-event="cloneBlock"]')
                .removeClass()
                .addClass('mr-btn-remove ' + class_remove_btn)
                .text('');
